    ...
    ?>
     ...
     <body>
         ...
         <form action="" method="post">
             ...
             名前<input type="text" name="name_2" value=<?php echo $name_ed ?> placeholder="名前">
             コメント<input type="text" name="comment4" value=<?php echo $com_ed ?>　placeholder="コメント">
         ...
         <form action="" method="post"><br>
             番号<input type="text" name="comment2" placeholder="変更する番号"　>
         パスワード <input type="text" name="pass2"　 >
         <input type="submit" name=but_2 value="削除"><br>
         </form>
         <!--編集機能-->
     <form action="" method="post"><br>
             番号<input type="text" name="comment3" placeholder="変更する番号"　>
             パスワード <input type="text" name="pass3"　placeholder="パスワード" >
